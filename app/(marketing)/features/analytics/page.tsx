...
export default function AnalyticsPage() {
  return (
    <main>
      <FeatureHero
        headline="Referee Performance Analytics"
        subheadline="Detailed performance analytics show your strengths, weaknesses, and progress over time. Data-driven improvement for every referee."
        cta={{ label: 'View your analytics', href: '/auth/sign-up' }}
        accentColour="cyan"
      />
