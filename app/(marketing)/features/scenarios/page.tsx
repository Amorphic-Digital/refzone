...
export default function ScenariosPage() {
  return (
    <main>
      <FeatureHero
        headline="Referee Match Scenarios — Train With Real Decisions"
        subheadline="Over 100 algorithm-driven game scenarios recreate the pressure of real matches. Read the situation, make your call, and learn from instant expert analysis."
        cta={{ label: 'Start practicing scenarios', href: '/auth/sign-up' }}
        accentColour="pink"
      />
