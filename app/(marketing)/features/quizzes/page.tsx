...
export default function QuizzesPage() {
  return (
    <main>
      <FeatureHero
        headline="Laws of the Game Quiz — Master Every Rule"
        subheadline="Over 500 carefully crafted questions covering all 17 Laws of the Game. From basic rules to match-day edge cases — test yourself at any level."
        cta={{ label: 'Start a quiz', href: '/auth/sign-up' }}
        accentColour="purple"
      />
